...
const Background = ({ className = "" }) => {
  ...
  return (
    <footer
      className={`self-stretch bg-homeaccrediancom-mine-shaft1 flex flex-row items-end justify-between py-8 pr-[19px] pl-[360px] box-border max-w-full gap-[20px] text-left text-sm text-homeaccrediancom-nero font-homeaccrediancom-roboto-bold-17 mq900:pl-[90px] mq900:pt-[21px] mq900:pb-[21px] mq900:box-border mq450:pt-5 mq450:pb-5 mq450:box-border mq1300:pl-[180px] mq1300:box-border mq1650:flex-wrap mq1650:justify-center ${className}`}
    >
      <div className="w-[1200px] flex flex-col items-start justify-start pt-0 px-6 pb-10 box-border gap-[32.5px] max-w-[1200px] mq900:gap-[16px] mq1300:max-w-full">
        <div className="w-full flex flex-row flex-wrap items-start justify-center max-w-[1200px] mq1300:max-w-full">
          ...
          <div className="flex flex-col items-center justify-start py-0 px-[67px] box-border max-w-[384px] ml-[-2px] mq450:pl-5 mq450:pr-5 mq450:box-border mq450:max-w-full">
            <button className="cursor-pointer py-[5px] px-[38px] bg-homeaccrediancom-japanese-laurel rounded-lg box-border flex flex-row items-center justify-center min-w-[64px] whitespace-nowrap border-[1px] border-solid border-homeaccrediancom-nero hover:bg-cornflowerblue hover:box-border hover:border-[1px] hover:border-solid hover:border-gainsboro">
              <div className="relative text-sm tracking-[0.4px] leading-[25px] font-medium font-homeaccrediancom-roboto-bold-17 text-homeaccrediancom-nero text-center">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[40px] max-w-full text-xl mq900:gap-[20px]">
              ...
              <div className="flex-1 flex flex-col items-start justify-start pt-2 px-0 pb-[201.3px] box-border gap-[4.2px] max-w-[528px] mq900:max-w-full">
                ...
                <div className="w-[205.5px] flex flex-row items-start justify-start">
                  ...
                  <div className="flex-1 flex flex-row items-start justify-start">
                    <div
                      className="h-[27.2px] flex-1 relative cursor-pointer"
                    ...
                    <div
                      className="flex flex-row items-center justify-start py-0 pr-0 pl-4 cursor-pointer z-[1] ml-[-0.1px]"
                ...
                <div className="self-stretch flex flex-col items-start justify-start pt-2 px-0 pb-0 gap-[4px]">
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start gap-[4px] text-sm">
                    <div className="self-stretch flex flex-col items-start justify-start">
                      ...
                      >
                        <a className="[text-decoration:none] self-stretch relative tracking-[0.13px] leading-[21px] text-[inherit]">
                          About
                        </a>
                      </div>
                    </div>
