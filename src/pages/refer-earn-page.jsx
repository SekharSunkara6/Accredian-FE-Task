...
const ReferEarnPage = () => {
  return (
    <div className="w-full relative bg-homeaccrediancom-nero overflow-hidden flex flex-col items-end justify-start pt-0 px-0 pb-[0.1px] box-border leading-[normal] tracking-[normal] text-left text-base-9 text-homeaccrediancom-mine-shaft font-inter">
